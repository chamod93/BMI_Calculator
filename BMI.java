...
public class client_new extends javax.swing.JFrame {
    ...
    private void CalculateActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        try {
            outToServer.writeUTF(weight);
            outToServer.writeUTF(height);
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(client_new.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new client_new().setVisible(true);
            }
        });
        try {
            String Result;
